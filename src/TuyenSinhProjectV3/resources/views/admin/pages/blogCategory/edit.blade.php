...
@section('title', "Sửa danh mục {$category->name_category_blog}")
@section('content')
            ...
            <div class="col-12">
                ...
                <form action="{{ route('admin.blogCategory.update', $category->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="name_category_blog" name="name_category_blog" value="{{ $category->name_category_blog }}" required>
                    </div>
